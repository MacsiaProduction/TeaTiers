...
.PHONY: help build build-server build-app check check-server check-app test run-server clean docker-build docker-up docker-down
...
docker-up: ## Start the backend via docker compose
	docker compose up -d
