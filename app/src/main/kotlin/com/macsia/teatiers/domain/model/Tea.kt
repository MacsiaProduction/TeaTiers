...
data class Tea(
    ...
    // P1-1 sample-identity fields (#132): distinguish two samples of the SAME catalog tea by where/when
    // it was bought. All optional; shown as a disambiguator subtitle on the card/detail.
